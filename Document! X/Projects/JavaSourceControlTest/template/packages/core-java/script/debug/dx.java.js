...
(function (Innovasys) {
    ...
    (function (Content) {
        var Features;
        (function (Features) {
            var DxJavaDocumentFeature = /** @class */ (function (_super) {
                __extends(DxJavaDocumentFeature, _super);
                function DxJavaDocumentFeature() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
                DxJavaDocumentFeature.prototype.getName = function () {
                    return "dx-java";
                };
                DxJavaDocumentFeature.prototype.populateResponsiveConfiguration = function (configuration) {
                    ...
                    if (configuration.profileName === "mobile" || configuration.profileName === "tablet") {
                        ...
                        configuration.clickTargets.push(new Content.ResponsiveClickTarget("#i-hierarchy.section-content a,"
                            + "#i-syntax-section-content dd a", Content.ResponsiveClickTargetKind.inline));
                    }
                };
                return DxJavaDocumentFeature;
            }(Features.DxBaseDocumentFeature));
            Features.DxJavaDocumentFeature = DxJavaDocumentFeature;
            var DxJavaDocumentFeatureFactory = /** @class */ (function () {
                function DxJavaDocumentFeatureFactory() {
                }
                DxJavaDocumentFeatureFactory.prototype.createInstance = function (documentInstance) {
                    // Always enabled
                    return new DxJavaDocumentFeature(documentInstance);
                };
                return DxJavaDocumentFeatureFactory;
            }());
            Features.DxJavaDocumentFeatureFactory = DxJavaDocumentFeatureFactory;
        })(Features = Content.Features || (Content.Features = {}));
    })(Content = Innovasys.Content || (Innovasys.Content = {}));
})(Innovasys || (Innovasys = {}));
Innovasys.Content.DocumentFeatureConfiguration.registerDocumentFeatureFactory(new Innovasys.Content.Features.DxJavaDocumentFeatureFactory());

//# sourceMappingURL=innovasys.dx.java.js.map
