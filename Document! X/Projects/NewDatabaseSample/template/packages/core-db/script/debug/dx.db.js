...
(function (Innovasys) {
    ...
    (function (Content) {
        var Features;
        (function (Features) {
            var DxDatabaseDocumentFeature = /** @class */ (function (_super) {
                __extends(DxDatabaseDocumentFeature, _super);
                function DxDatabaseDocumentFeature() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
                        ...
                        switch (configuration.profileName) {
                            ...
                            case "mobile":
                                ...
                                configuration.tablesToPivot.push(new Content.ResponsiveTable("#i-columns-section-content table.i-column-list", function (originalTable, pivotDiv) {
                                    ...
                                    var primaryKeyRow = originalTable
                                        .find("td:first-child img")
                                        .first()
                                        .closest("tr");
                                    var primaryKeyColumnName = primaryKeyRow
                                        .children("td.i-link")
                                        .text();
                                    pivotDiv.find("span.btn").each(function (_, element) {
            ...
            var DxDatabaseDocumentFeatureFactory = /** @class */ (function () {
